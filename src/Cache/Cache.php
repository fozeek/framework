...
class Cache {
	...
	private static $defaultDirname = '/cache/';
	private static $defaultDuration = 60;

	public $dirname;
	public $duration; // Durée de vie du cache en minutes
	public $buffer;

	public static function setDefaultDirname($dirname) {
	...
	public function __construct($dirname = null, $duration = null) {
		$this->dirname = (empty($dirname)) ? self::$defaultDirname : $dirname ;
		$this->duration = (empty($duration)) ? self::$defaultDuration : $duration ;
	}
